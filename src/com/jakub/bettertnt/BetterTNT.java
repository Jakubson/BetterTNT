...
public class BetterTNT extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        commandSender.sendMessage("§aBetterTNT §8| §7The plugin has been enabled!");
        commandSender.sendMessage("§aBetterTNT §8| §7Check my other plugins: https://www.spigotmc.org/resources/authors/207724/");
    }
